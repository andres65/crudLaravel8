<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{--  {{ Form::label('eps_id') }}
            {{ Form::text('eps_id', $tbUsuario->eps_id, ['class' => 'form-control' . ($errors->has('eps_id') ? ' is-invalid' : ''), 'placeholder' => 'Eps Id']) }}
            {!! $errors->first('eps_id', '<div class="invalid-feedback">:message</p>') !!}  --}}
        </div>
        ...
        <div class="form-group">
            ...
            {{--  {{ Form::text('rol_id', $tbUsuario->rol_id, ['class' => 'form-control' . ($errors->has('rol_id') ? ' is-invalid' : ''), 'placeholder' => 'Rol Id']) }}
